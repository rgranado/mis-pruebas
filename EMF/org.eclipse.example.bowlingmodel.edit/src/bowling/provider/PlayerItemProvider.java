	...
	protected void addHeigthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Player_heigth_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Player_heigth_feature", "_UI_Player_type"),
				 BowlingPackage.Literals.PLAYER__HEIGTH,
				 true,
				 false,
				 false,
