...
public interface BowlingPackage extends EPackage {
	...
	/**
	 * Returns the meta object for the attribute '{@link bowling.Player#getHeigth <em>Heigth</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Heigth</em>'.
	 * @see bowling.Player#getHeigth()
	 * @see #getPlayer()
	 * @generated
	 */
	EAttribute getPlayer_Heigth();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EAttribute PLAYER__HEIGTH = eINSTANCE.getPlayer_Heigth();
